...
<div class="mobile-only">
  <aside id="drawer"
         style="position:fixed; top:0; right:0; bottom:0; width:320px;
                background:#0f1114; color:#fff;
                transform:translateX(100%); transition:transform .3s ease;
                z-index:10000; box-shadow:-4px 0 12px rgba(0,0,0,.5);
                padding:20px; display:flex; flex-direction:column;">
    <button id="closeDrawer"
            style="align-self:flex-end; background:none; border:none; color:#fff;
...
<script>
  (function(){
    ...
    if (openBtn && drawer)  openBtn.addEventListener('click', () => drawer.style.transform = 'translateX(0)');
    if (closeBtn && drawer) closeBtn.addEventListener('click', () => drawer.style.transform = 'translateX(100%)');
  })();
</script>
